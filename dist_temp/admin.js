    ...
    function renderTimeline() {
        ...
        (currentData.timeline || []).forEach((item, index) => {
            ...
            div.innerHTML = `
                ...
                <div class="form-group">
                    <label>Video URL (YouTube/Drive/Direct)</label>
                    <input type="text" value="${item.videoUrl || ''}" placeholder="Paste Video Link" oninput="updateTimeline(${index}, 'videoUrl', this.value)" style="padding: 5px;">
                </div>
            `;
        ...
        (currentData.gallery || []).forEach((item, index) => {
            ...
            div.innerHTML = `
                ...
                <div class="form-group" style="text-align: center;">
                    ...
                    <input type="text" value="${item.videoUrl || ''}" id="gallery-video-${index}" placeholder="OR Paste Video Link"
                        oninput="updateGallery(${index}, 'videoUrl', this.value)"
                        style="width: 100%; margin-top: 5px; padding: 5px; border-top: 1px solid #ddd;">
                </div>
    ...
    if (saveBtn) {
        saveBtn.addEventListener('click', async (e) => {
            ...
            const updatedData = {
                ...
                timeline: currentData.timeline || [], // Explicitly save Timeline
                gallery: currentData.gallery || [] // Explicitly save Gallery
            };
